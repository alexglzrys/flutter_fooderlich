...
class Card3 extends StatelessWidget {
  ...
  // Método para crear un conjunto de chips por cada tag declarado en la receta
  // Solo crea 6 por receta
  List<Widget> createTagChip() {
    final chips = <Widget>[];
        ...
        child: Stack(children: [
          ...
          Center(
            child: Wrap(
              ...
              // El metodo local createTagChip() genera el arrglo de widgets de tipio chip (para hacer más legible la lectura del widget principal)
              children: createTagChip(),
            ),
          )
        ]),
      ),
